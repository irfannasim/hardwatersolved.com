---
title: "Why a Water Softener Is Not Using Salt"
seoTitle: "Water Softener Not Using Salt? 6 Proven Checks in Order"
...
ogImageAlt: "Two cupped hands holding a heap of coarse white salt crystals in sunlight, the salt that should be dissolving out of a softener brine tank but is not"
faqs:
  - question: "Why is my water softener not using any salt?"
    answer: "Either the softener is not regenerating at all, or it is regenerating without drawing brine. Not regenerating is usually a power, clock, bypass, meter or programming problem. Regenerating without drawing brine is usually a salt bridge, a blocked brine well, an air leak in the brine line, a clogged injector or a restricted drain line. Start a manual regeneration and watch the water level in the brine tank: if the valve never moves, it is the first group; if it moves but the level never falls, it is the second."
  - question: "How do I know if my water softener is regenerating?"
    answer: "Most electronic controls show the cycle step on the display during regeneration, and many keep a count of days since the last one. You can also listen at the valve and the drain in the early morning, when most units are set to regenerate, or start one manually and watch. On a Fleck 5600SXT, holding the Extra Cycle button for five seconds starts an immediate regeneration; on a Clack WS1, holding REGEN for three seconds does the same. Water running to the drain and the display counting down confirm the valve is cycling."
  - question: "Is it normal for a water softener to use very little salt?"
    answer: "It can be. A small household with moderately hard water and a demand-metered softener may regenerate only every week or two and use one 40-pound bag in six to eight weeks. What matters is whether the water is soft. Test a cold tap: if hardness reads at or near zero, low salt use is simply low demand. If the water has turned hard while the salt level has stayed put, the softener has a fault."
  - question: "Can a water softener regenerate without using salt?"
    answer: "Yes, and that is exactly what makes this fault so easy to miss. The control valve cannot measure brine strength, so it runs backwash, brine draw, rinse and refill on schedule whether or not any brine reached the resin. With a salt bridge, a plugged injector or a leaking brine line, the display shows a completed regeneration while the resin is rinsed with plain water and never recharged."
  - question: "How long should the salt level take to go down in a softener?"
    answer: "Long enough to be measurable over two weeks. A typical residential regeneration uses somewhere between about 4 and 15 pounds of salt depending on the salt setting and resin volume, so a unit regenerating weekly should drop the level visibly within a fortnight. Mark the level with tape on the tank wall and check it after two weeks. No movement in that time, with hard water at the tap, confirms a fault."
  - question: "Should there be water in the brine tank if the softener is not using salt?"
    answer: "The water level is one of the best clues. A tank much fuller of water than usual suggests the softener is refilling but not drawing brine out. A completely dry tank on a unit that normally keeps water in it suggests the refill is failing. A few inches of water under the salt is normal for most tanks that refill after regeneration, while tanks set up to pre-fill before regeneration sit nearly dry between cycles by design."
---
...
| Water hard, salt dropping fast | Different problem — see [why a water softener uses too much salt](/blog/water-softener-using-too-much-salt/) |

**The salt-level trap.** The salt you can see is not always the salt being used. A crust can hold the top of the pile up while the salt beneath it dissolves away. Push a broom handle down through the salt before trusting the line — the method is in [how to identify and break a salt bridge](/blog/water-softener-salt-bridge/).
...
1. **Note the water level.** Lift the brine well cap, shine the flashlight down, and measure from the top of the well to the water surface. Write the number down.
2. **Check the bypass is in service.** A valve left in bypass is the cheapest fault there is.
...
- **Fleck 5600SXT:** hold the Extra Cycle button for five seconds. The valve moves to backwash; press Extra Cycle once more to skip ahead to brine draw and slow rinse. The full sequence is set out in the [Fleck 5600SXT service manual](https://www.pentair.com/content/dam/extranet/web/nam/fleck/manuals/42684-fleck-5600sxt-downflow-manual.pdf).
- **Clack WS1:** hold REGEN for three seconds to start immediately. The [Clack WS1 manual](https://www.clackcorp.com/wp-content/uploads/2025/10/V3115_WS1_1.25.pdf) lists the cycle order, which on a downflow softener runs backwash, regenerate (brine draw), backwash, rinse, then fill.
...
**Bypass.** It sounds obvious, but a bypass left partly open after plumbing work lets hard water around the softener while the unit sits idle. The Fleck troubleshooting chart lists an open bypass as a cause of hard water. Leaking or stiff bypass valves have their own diagnosis in [water softener bypass valve leaking](/blog/water-softener-bypass-valve-leaking/).
...
**Motor, cam or board.** If a manual regeneration will not start at all, or the display shows an error, the drive is the likely culprit. Error meanings are brand-specific; start with [water softener error code or blank display](/blog/water-softener-error-code-or-blank-display/), and if the unit starts but never finishes, see [water softener stuck in regeneration](/blog/water-softener-stuck-in-regeneration/). The broader diagnosis of a valve that will not cycle lives in [why a water softener will not regenerate](/blog/water-softener-will-not-regenerate/).
...
A dry tank on a unit that should hold water is its own fault with its own causes — the timing check that separates normal from broken is in [why there is no water in the brine tank](/blog/no-water-in-brine-tank/).
...
| Symptom | Start here |
|---|---|
| Salt disappearing far faster than it should | [Water softener using too much salt](/blog/water-softener-using-too-much-salt/) |
| Brine tank filling up or overflowing | [Brine tank full of water or overflowing](/blog/brine-tank-full-of-water-or-overflowing/) |
| Brine tank dry | [No water in the brine tank](/blog/no-water-in-brine-tank/) |
| Valve will not start a cycle | [Water softener will not regenerate](/blog/water-softener-will-not-regenerate/) |
| Valve starts but never finishes | [Water softener stuck in regeneration](/blog/water-softener-stuck-in-regeneration/) |
| Water running to the drain around the clock | [Water softener constantly draining](/blog/water-softener-constantly-draining/) |
| Error code or dead display | [Error code or blank display](/blog/water-softener-error-code-or-blank-display/) |
| Grinding, humming or hissing | [Water softener making noise](/blog/water-softener-making-noise/) |
| Water weeping from the valve body | [Leaking at the control head](/blog/water-softener-leaking-at-control-head/) |
| Pressure dropped after installation | [Low water pressure after a water softener](/blog/low-water-pressure-after-water-softener/) |
| Pipes banging when taps close | [Water hammer after a water softener](/blog/water-hammer-after-water-softener/) |
| Sputtering taps after a service | [Air in faucets after softener service](/blog/air-in-faucets-after-softener-service/) |
...
**Tired resin.** A bed that sat exhausted for months while a bridge starved it can foul with iron or organics, and a softener drawing brine perfectly will still fail to soften. If hardness stays high after two good regenerations, read [water softener resin fouling](/blog/water-softener-resin-fouling/).

**When to stop.** If the fault is inside the valve — seals, pistons, the motor or the board — and your model needs special tools or parts you cannot identify, that is a sensible point to hand over. [When to call a water softener technician](/blog/when-to-call-a-water-softener-technician/) covers what a visit should include and what it should cost. Penn State Extension's guide to [water softening](https://extension.psu.edu/water-softening) is a useful neutral reference on how timed and demand-controlled units differ, which matters when you are deciding whether a control is worth repairing.

## The Whole Diagnosis, In Order

1. **Test a cold tap.** Soft water with slow salt use is not a fault.
2. **Tape-mark the salt line** and confirm it has not moved in two weeks.
3. **Check bypass, power and clock.**
4. **Probe the salt for a bridge** with a broom handle.
5. **Measure the water level** in the brine well.
6. **Start a manual regeneration** and watch for twenty minutes.
7. **No valve movement:** work Branch A — settings, meter, motor, board.
8. **Valve moves, level does not fall:** work Branch B — fittings, injector, drain line, brine well, pressure.
9. **Fix, wait four hours, regenerate twice** a day apart, and re-test.
10. **Re-check the tape mark in two weeks.**
